 ...
 */
const nextConfig = {
  // Conditionally set the output mode. 'export' is required for TCB static hosting.
  // This replaces the previous 'standalone' setting to fit the new deployment strategy.
