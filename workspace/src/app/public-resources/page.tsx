...
import { collection, getDocs, query, orderBy, addDoc, updateDoc, doc, deleteDoc, serverTimestamp, Timestamp } from '@/lib/cloudbase-compat';
...
function ManualResourceManagement() {
    ...
    const confirmDelete = async () => {
        ...
        try {
            await deleteDoc(doc('resources', selectedResource.id));
