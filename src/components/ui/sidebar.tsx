      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            side={side}
          >
             {/* Accessibility: Add a screen-reader-only title and description */}
            <SheetHeader className="sr-only">
              <SheetTitle>主菜单</SheetTitle>
              <SheetDescription>应用的主导航菜单</SheetDescription>
            </SheetHeader>
      ...
      >
        ...
        >
          <div
            ...
            "dark:bg-gradient-to-b dark:from-secondary dark:to-muted")}
          >
            {children}
          </div>
  ...
  (
    ...
    const button = (
      <Comp
        ...
        className={cn(sidebarMenuButtonVariants({ variant, size }), isActive ? "variant-primary-gradient" : "", className)}
        {...props}
      />
    )
