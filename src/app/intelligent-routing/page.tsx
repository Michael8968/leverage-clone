...
import { Route, Loader2, Frown, Save, Wand2 } from 'lucide-react';
    ...
    const fetchStrategy = useCallback(async () => {
        ...
        try {
            ...
            if (docSnap.exists()) {
                ...
                setStrategy(defaultStrategy as IntelligentRoutingStrategy);
                setStrategyText(defaultStrategy.strategyText);
                setTemperature(defaultStrategy.temperature);
            }
        } catch (error) {
        ...
        <AppLayout>
            <div className="p-4 md:p-8 space-y-8">
                <header>
                    ...
                    <p className="text-muted-foreground">使用自然语言定义唯一的、全局生效的用户请求路由策略，AI将遵循此策略进行智能分配。</p>
                </header>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            在此描述您希望系统如何将用户的请求分配给设计师。您可以考虑设计师的技能、闲忙状态、用户等级、问题类型等因素。
                        </CardDescription>
                    </CardHeader>
                            ...
                            <div className="space-y-4">
                             ...
                             <>
                                <Alert>
                                    ...
                                    <AlertDescription>
                                        您在此处定义的策略将作为最高指令，AI会结合用户的实时请求、设计师的在线状态、技能、排队数等信息，综合理解并执行您的策略，做出最优的分配决策。
                                    </AlertDescription>
                                </Alert>
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                         <Label htmlFor="temperature-slider">AI决策温度 (创造性)</Label>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        较低的温度（如0.1）使AI严格遵循策略；较高的温度（如0.9）允许AI进行更灵活的、创造性的匹配。
                                    </p>
                                </div>
                             </>
                         )}
